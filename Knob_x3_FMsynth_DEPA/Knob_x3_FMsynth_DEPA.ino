...
const int KNOB1_PIN = 1; // set the input for the knob to analog pin 1
...
void updateControl(){
  // read the knob
  int knob_1 = mozziAnalogRead(KNOB1_PIN); // value is 0-1023
  ...
  int knob_2 = mozziAnalogRead(KNOB2_PIN); // value is 0-1023
 ...
 // calculate the fm_intensity
  ...
  int knob_3 = mozziAnalogRead(KNOB3_PIN); // value is 0-1023
